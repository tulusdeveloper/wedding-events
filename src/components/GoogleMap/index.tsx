...
const GoogleMap = () => {
  return (
    <div className="rounded-sm border border-stroke bg-slate-950 px-5 pt-6 shadow-default dark:border-strokedark dark:bg-slate-950 sm:px-7.5 xl:pb-1">
      <div className="max-w-full overflow-x-auto" style={{ height: '500px' }}>
        <iframe
          src={mapSrc}
          width="100%"
          height="100%"
